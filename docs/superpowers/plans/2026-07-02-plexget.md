...
def test_subsequence_match_case_insensitive():
    ...
    # "sc" is a subsequence of both Se(...)veran(c)e and Su(c)cession; order preserved
...
def download_part(
    ...
    *,
    ...
    except BaseException:  # cleanup partial temp on interruption/quit, then re-raise
    ...
    *,
    ...
    for index, part in enumerate(parts, start=1):
        ...
        while True:
            attempts += 1
            try:
                # download_part_segmented falls back to download_part when segments<=1
...
def download_part_segmented(
    ...
    *,
    ...
    effective = min(segments, part.size)  # never request more ranges than bytes
    ...
    except BaseException:  # clean up partial temp on any segment failure
        tmp.unlink(missing_ok=True)
        raise
